                    ...
                    value: function() {
                        ...
                        if (this._letters.forEach((function(n, r) {
                                var o = n.style,
                                    ...
                                    var arsaColor = "yellow,blue,green,aqua,blueViolet,Chartreuse,crimson,darkBlue,darkGreen,DarkSlateGray,DeepPink,DarkViolet,indigo,lawngreen,lightseagreen,lime,limegreen".split(',')
